...
class StarButton extends Component {
  ...
  renderIcon() {
    ...
    if (typeof starIconName === 'string') {
      if (starIconName === 'ios-star-outline') {
        iconElement = (<IosStarOutline fontSize={String(starSize)} color={starColor} style={newStarStyle} />)
      } else if (starIconName === 'ios-star') {
        iconElement = (<IosStar fontSize={String(starSize)} color={starColor} style={newStarStyle} />)
      } else if (starIconName === 'ios-star-half') {
        iconElement = (<IosStarHalf fontSize={String(starSize)} color={starColor} style={newStarStyle} />)
      }
    } else {
      const imageStyle = {
        width: starSize,
